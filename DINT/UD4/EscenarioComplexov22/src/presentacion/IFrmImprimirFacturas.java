...
public class IFrmImprimirFacturas extends javax.swing.JInternalFrame {
     ...
     */
    public IFrmImprimirFacturas() throws MalformedURLException, HelpSetException {
        initComponents();
        setResizable(true);
    ...
    private void filtrar() {
        ...
        ArrayList arIdFacturas = new ArrayList();
        String strWhere = "1";
        ...
        arIdFacturas = ConsultasSQL.recuperarIdFacturas(strWhere);
        if (arIdFacturas.isEmpty()) {
            txtResultado.setText("Non existen facturas con ese filtro");
        } else {
            if (arIdFacturas.size() == 1) {
                txtResultado.setText(String.valueOf(arIdFacturas.size()) + " factura seleccionada");
            } else {
                txtResultado.setText(String.valueOf(arIdFacturas.size()) + " facturas seleccionadas");
            }
        }
    }
