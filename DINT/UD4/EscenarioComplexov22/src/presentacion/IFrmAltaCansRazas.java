...
public class IFrmAltaCansRazas extends javax.swing.JInternalFrame {
 ...
 private javax.swing.DefaultListModel<Propietario> modeloPropietarios; 
    ...
    private void cargarRazas()
    {
        ...
        ArrayList razas=ConsultasSQL.recuperarTodalasRazas();
        if(razas==null)
        {
        ...
        else
        {
            ...
            {
                modeloRazas.addElement((Raza)razas.get(i));
            }
        }        
    }
    /**
    ...
    private void initComponents() {
        ...
        panSuperior.setPreferredSize(new java.awt.Dimension(491, 50));
        panSuperior.setLayout(new java.awt.GridBagLayout());
        ...
        panSuperior.add(lblAccion, gridBagConstraints);
        ...
        panSuperior.add(cmbTipoAlta, gridBagConstraints);

        getContentPane().add(panSuperior, java.awt.BorderLayout.NORTH);

        panCentral.setLayout(new java.awt.CardLayout());
        ...
        panCentral.add(pnlNovaRaza, "RAZA");
    ...
    private void cmbTipoAltaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbTipoAltaItemStateChanged
        ...
        if(evt.getStateChange()==ItemEvent.SELECTED)
        {
            ...
            {
                CardLayout panelCentralLayout=(CardLayout)this.panCentral.getLayout();
                panelCentralLayout.show(this.panCentral, "CAN");
                setTitle("Novo can");
            }
            else
            {
                CardLayout panelCentralLayout=(CardLayout)this.panCentral.getLayout();
                panelCentralLayout.show(this.panCentral, "RAZA");                                    
                setTitle("Nova raza");
            }
        }
    ...
    private void btnGardarCanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGardarCanActionPerformed
        ...
        if(ConsultasSQL.inserirCan(can)==-1)
        {
