...
private DefaultTableModel modeloVacinacions;
    ...
    private void cargarPropietarios()
    {
        ...
        ArrayList propietarios=ConsultasSQL.recuperarTodolosPropietarios();
        ...
        else
        {
            ...
            {
                modeloPropietarios.addElement((Propietario)propietarios.get(i));
            }
        }        
    }        
    ...
    private void cargarVacinas()
    {
        ...
        ArrayList vacinas=ConsultasSQL.recuperarTodalasVacinas();
        if(vacinas==null)
        {
        ...
        else
        {
            ...
            {
                modeloVacinas.addElement((Vacina)vacinas.get(i));
            }
        }        
    }            
    ...
    private void cargarCans(String dni)
    {
        ...
        ArrayList cans=ConsultasSQL.recuperarTodolosCansDunPropietario(dni);
        if(cans==null)
        {
        ...
        else
        {
            ...
            {
                modeloCans.addElement((Can)cans.get(i));
            }
        }        
    }            
    ...
    private void cargarVacinacions()
    {
        ...
        ArrayList vacinacions=ConsultasSQL.recuperarTodalasVacinacionsDunCan(modeloCans.getElementAt(cmbCans.getSelectedIndex()).getChip());
        if(vacinacions==null)
        {
        ...
        else
        {
            for(int i=0;i<vacinacions.size();i++)
            {
                ...
                ArrayList vacina=ConsultasSQL.recuperarUnhaVacinaDadoSeuCodigo(((Vacinacion)vacinacions.get(i)).getCodVacina());
                ...
                else
                {
                    ...
                    modeloVacinacions.setValueAt(vacina.get(0), filaActual-1, 0);
                    modeloVacinacions.setValueAt(((Vacina)vacina.get(0)).getNumTotalDoses(), filaActual-1, 1);
                    modeloVacinacions.setValueAt(((Vacinacion)vacinacions.get(i)).getDose(), filaActual-1, 2);
                    modeloVacinacions.setValueAt(Datas.DataFormatoMySQLYYYY_GUION_MM_GUION_DDAFormatoDia_BARRA_Mes_BARRA_Anho(((Vacinacion)vacinacions.get(i)).getData()), filaActual-1, 3);                                        
                    modeloVacinacions.setValueAt(vacinacions.get(i), filaActual-1, 4);                                    
                }
    ...
    private void btnVacinarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVacinarActionPerformed
        ...
        if(ultimaDose<modeloVacinas.getElementAt(cmbVacinas.getSelectedIndex()).getNumTotalDoses())
        {
            ...
            if(ConsultasSQL.inserirVacinacion(vacinacion)==-1)
            {
