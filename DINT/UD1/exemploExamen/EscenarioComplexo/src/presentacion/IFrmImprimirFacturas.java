...
public class IFrmImprimirFacturas extends javax.swing.JInternalFrame {
     ...
     */
    public IFrmImprimirFacturas(FrmPrincipal pai) {
        initComponents();
        this.pai=pai;
    ...
    private void initComponents() {
        ...
        btnImprimir1.setBackground(new java.awt.Color(40, 100, 246));
        btnImprimir1.setFont(new java.awt.Font("Ubuntu", 1, 18)); // NOI18N
        btnImprimir1.setForeground(new java.awt.Color(254, 254, 254));
        btnImprimir1.setMnemonic('i');
        btnImprimir1.setText("Imprimir");
        btnImprimir1.setNextFocusableComponent(btnFiltrar);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 0, 10);
        pnlBotones.add(btnImprimir1, gridBagConstraints);
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        // TODO add your handling code here:
        btnImprimir.setText("Imprimindo " + txtResultado.getText() + " resultados...");
        try {
            Thread.sleep(1000);
        } catch (InterruptedException ex) {
            Logger.getLogger(IFrmImprimirFacturas.class.getName()).log(Level.SEVERE, null, ex);
        }
        btnImprimir.setText("Imprimir");
