 ...
 * @author usuario
 */
public class IntfMenuContextual extends javax.swing.JFrame {

    /**
     * Creates new form IntfMenuContextual
     */
    public IntfMenuContextual() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        pumnuMenuPrincipal.add(mnuOpcions);
        ...
        lblPrema.setText("Prema co botón dereito sobre esta etiqueta para despregar o menú contextual");
        lblPrema.setComponentPopupMenu(pumnuMenuPrincipal);
        getContentPane().add(lblPrema, new java.awt.GridBagConstraints());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntfMenuContextual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntfMenuContextual().setVisible(true);
            }
        });
    }
