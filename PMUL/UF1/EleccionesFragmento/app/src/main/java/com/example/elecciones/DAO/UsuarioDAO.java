...
public class UsuarioDAO {
    public static boolean comprobarContrasenha(String usuario, String contrasenha) {
        ...
        Cursor consulta = db.rawQuery(sentencia, new String[]{usuario});
    ...
    public static boolean getHaVotado(String usuario) {
        ...
        // Consulta parametrizada
        String sentencia = "SELECT * FROM usuarios WHERE nif = ? AND haVotado = 1";
        Cursor consulta = db.rawQuery(sentencia, new String[]{usuario});
    ...
    public static void setHaVotado(String nif) {
        ...
        // Consulta parametrizada
        String sentencia = "UPDATE usuarios SET haVotado = 1 WHERE nif = ?";
        bd.execSQL(sentencia, new String[]{nif});
    }
